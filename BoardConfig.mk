...
# Assert
TARGET_OTA_ASSERT_DEVICE := fogo,fogo_g
...
BOARD_QTI_DYNAMIC_PARTITIONS_SIZE := 6710886400 # BOARD_SUPER_PARTITION_SIZE/2 - 4MB
...
BOARD_RAMDISK_USE_VENDOR_BOOT := true
BOARD_VENDOR_BOOTIMAGE_PARTITION_SIZE := 70359552
BOARD_MKVENDORBOOTIMG_ARGS += --ramdisk_offset $(BOARD_RAMDISK_OFFSET)
BOARD_MKVENDORBOOTIMG_ARGS += --tags_offset $(BOARD_KERNEL_TAGS_OFFSET)
BOARD_MKVENDORBOOTIMG_ARGS += --header_version 4
